...
test.describe('Finished Cards View', () => {
  test('should display the finished cards page', async ({ page }) => {
    // 1. Log in
    await page.goto(`${BASE_URL}/login`);
    await page.getByTestId('login-pin').fill(ADMIN_PIN);
    await page.waitForURL('**/customers');

    // 2. Navigate to Dashboard then to Finished Cards
    await page.goto(`${BASE_URL}/dashboard`);
    await page.locator('h3', { hasText: 'Cuentas Saldadas' }).click();
    await page.waitForURL('**/dashboard/finished-cards');
